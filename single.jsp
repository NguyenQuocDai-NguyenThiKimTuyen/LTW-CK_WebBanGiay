		...
		<div class="single">
			<div class="col-md-9 top-in-single">
				<div class="col-md-5 single-top">
					<center>
						<a><img src="images/<%=sp.getHinhAnh()%>" alt="" /></a>
					</center>
					<ul id="etalage">
						<li><a href="single.jsp?MaSP=<%=sp.getMaSP()%>"><img
								src="images/<%=sp.getHinhAnh()%>" alt="" /></a></li>
				...
				<div class="col-md-7 single-top-in">
					<div class="single-para">
						...
						<br>
						<div>
							<a href="CartController?command=plus&MaSP=<%=MaSP%>"
